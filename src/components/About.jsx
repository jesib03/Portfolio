...
function About() {
  return (
    <Grid id="about" mt="5rem" mb="5rem" pl="6.25rem"
    pr="6.25rem">
      <Heading
        color="#D52AA6"
        justify="center"
      ...
      <Flex alignItems="center" mt="4">
        ...
        <Box flex="1" flexDirection="column">
          ...
          >
            ...
            technologies, using Modern frameworks. You can simple describe me as
            a front end developer addict.
          </Text>
          ...
          <Button
            ...
            onClick={() =>
              window.open("https://calendly.com/jesib03", "_blank")
            }
          >
            Hire Me
          </Button>
